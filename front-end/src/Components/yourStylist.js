  ...
  render() {  
    return (
      <div className='yourStylist'>
        ...
        <button className='button' onClick={this.handleOpen}> <img className='img' src='http://www.gentlemen-barberclubs.de/images/cta.jpg' alt='Button Image'/> Book an appointment</button>
